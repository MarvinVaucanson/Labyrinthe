...
class TableauScore :
    ...
    def afficher(self):
        ...
        for ligne in contenu:
            self.scoresave.append(ligne.strip())
        print (self.scoresave)

        self.scoresave.sort(reverse = True)
        print(self.scoresave)
...
class Jeu:
    ...
    def loop(self):
        ...
        while self.continuer:
            ...
            self.minuteur.score = self.minuteur.score + 1
...
class Fenetres():
    ...
    def scoreboard(self):
        ...
        fenetre.blit(retour,(550,550))
        continuer = True
        self.tabscore.afficher()
        fenetre.blit(pygame.font.Font('Retro Gaming.ttf',70).render((str(self.tabscore.scoresave[0])), True, (210, 155, 15)), (295, 175))
        fenetre.blit(pygame.font.Font('Retro Gaming.ttf',70).render((str(self.tabscore.scoresave[1])), True, (128, 128, 128)), (130, 275))
        fenetre.blit(pygame.font.Font('Retro Gaming.ttf',70).render((str(self.tabscore.scoresave[3])), True, (210, 155, 15)), (305, 234))
        while continuer:
